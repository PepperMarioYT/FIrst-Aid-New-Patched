...
public final class FirstAidDataReloadListener extends SimplePreparableReloadListener<FirstAidDataReloadListener.Data> implements IdentifiableResourceReloadListener {
    ...
    private static final Identifier RELOAD_ID = Identifier.fromNamespaceAndPath(FirstAid.MODID, "data_reload");
    ...
    protected Data prepare(ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        SimpleJsonResourceReloadListener.scanDirectory(resourceManager, DAMAGE_LISTER, JsonOps.INSTANCE, FirstAidBaseCodecs.DAMAGE_DISTRIBUTION_TARGETS_DIRECT_CODEC, damageTargets);
        SimpleJsonResourceReloadListener.scanDirectory(resourceManager, DEBUFF_LISTER, JsonOps.INSTANCE, FirstAidBaseCodecs.DEBUFF_BUILDERS_DIRECT_CODEC, debuffBuilders);
