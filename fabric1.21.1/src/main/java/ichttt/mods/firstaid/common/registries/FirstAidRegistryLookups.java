...
public class FirstAidRegistryLookups {
    ...
    private static volatile Map<ResourceLocation, IDamageDistributionTarget> DATA_DAMAGE_TARGETS = Collections.emptyMap();
    private static volatile Map<ResourceLocation, IDebuffBuilder> DATA_DEBUFF_BUILDERS = Collections.emptyMap();
    ...
    private static Map<DamageType, IDamageDistributionAlgorithm> buildDamageDistributions(HolderLookup.Provider lookupProvider) {
        ...
        for (Map.Entry<ResourceLocation, IDamageDistributionTarget> entry : DATA_DAMAGE_TARGETS.entrySet()) {
    ...
    public static void updateData(Map<ResourceLocation, IDamageDistributionTarget> damageTargets, Map<ResourceLocation, IDebuffBuilder> debuffBuilders) {
